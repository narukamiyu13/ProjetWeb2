...
<body id="page-top">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll">Sign-in</a>
                    </li>
                    <li>
                        <a class="page-scroll">Sign-up</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
                ...
                <div class="col-sm-12">
                    <div class="header-content">
                        <div class="header-content-inner">
                            <h1>Foodie: Une personne ayant un intérêt particulier dans l'alimentation; Un gourmet.</h1>
            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <h2 class="section-heading">
                        Découvrez ce que tout le buzz est!</h2>
                    <p>
                        Inscrivez-vous des aujourd'hui</p>
    ...
    <section class="cta">
        <div class="cta-content">
            <div class="container">
                <h2>
Arrêtez d'attendre.<br>Commencez à partager</h2>
