...
DESCRIPTION : modele qui declare un utilisateur et qui gere ses fonctionalites intrinseque
...
class Utilisateur extends Modele{
    ...
    function desabonner($idUtilisateurQuiNavigue){
        ...
        | -------------------------
        | DESCRIPTION
        |   modifie les informations du profil de lutilisateur connecté
        |------------------------------------- */
